...
if(isset($_POST['nome'])){
    ...
    if($idescolha === "sim"){
     ...
     header('Location:cadastro-voluntario.php');
 
    }elseif($idescolha === "nao"){

        header('Location:cadastro-dados-usuario.php');
                        ...
                        <div id="teste">
                            ...
                            <div class="contact100-form-checkbox">
                                <div class="form-check form-check-inline">
                                    <div>
                                    <input class="form-check-input" required type="radio" name="inlineRadioOptions" id="inlineRadio1" value="sim">
                                </div>
                                <div>
                                ...
                                <div class="form-check form-check-inline">
                                    <div>
                                        ...
                                        <input class="form-check-input" required type="radio" name="inlineRadioOptions" id="inlineRadio2" value="nao">
                                    </div>
                                    <div>
